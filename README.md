...
- **Архивация в базу знаний** — готовый MD транскрипта копируется в предметную папку `~/gdrive/Brain/` (выбор по правилам `Brain/AGENTS.md`), рядом сохраняется подробный пересказ `YYYY-MM-DD_sub_<имя>.md` (до 16000 символов, та же структура «Главная мысль / Ключевые тезисы / Вывод» + блок метаданных); в ответе пользователю — блок с метаданными и названием папки Brain
